...
### Future Features
My original plan was to include an iframe with a pinned location of the Church as displayed in my wireframes. I didn't have enough time to figure out the best approach to do this. So, it will be a future feature. 

## Testing

1. As a new visitor, I want to know what the website is about. 
 * The landing page provides enough visual evidence for this. We have the hero image showing a worship group performing at the altar. The Who we are, and Meet our Pastors also provides detailed insight into the pages aim. In the Program section, the headings and images also provide enough visual and reading material about the page. 

2. As a new visitor, I want to learn about the aim of the website, what it is about and who runs the congregation. 
 * This is very evident from the underlined Headings and reading material provided in the About Section. 

3. As a new visitor, I want to know what the usual program schedule is. 
 * The straightforward structure of the Program section using text and images provides this. 

4. As a new visitor, I want to connect to any social media pages the church has. 
 * The social media links are provided in the footer on all 3 pages of the website. Each icon that is clicked opens in a new tab leading the use into the specific social media platform. 
...
## Credits
 ...
 ### Content
Most of written content on the website has been generated by ChadGPT.
* [ChadGPT](https://chat.openai.com/)   

Borrowed Code:
[code taken from tutorial](https://www.youtube.com/watch?v=nFLERAgAY6M&t=112s) 

Some code might be similar to :
[Kalmar Stadsmission](https://fridawikell.github.io/kalmar-stadsmission/index.html)
and
[Rebalance Relax](https://elenaderothschild.github.io/Rebalance-Relax/index.html)
as I have investigated the best approach for my Contact form and for my Program section. 

Any media and videos have been sourced by :
* [Pexels](pexels.com)
* [Facebbok page of my local Church](https://www.facebook.com/wayoflifeennis)
...
![](https://github.com/MiaTothova/Mission-of-Faith/blob/main/deploy-images/1D.jpg)
 
2. Find GitHub Pages in the menu.
![](https://github.com/MiaTothova/Mission-of-Faith/blob/main/deploy-images/2D.jpg) 
...
![](https://github.com/MiaTothova/Mission-of-Faith/blob/main/deploy-images/3D.jpg)

4. After the page re-freshed, I got a message "Your site is live at https://miatothova.github.io/Mission-of-Faith/index.html".
![](https://github.com/MiaTothova/Mission-of-Faith/blob/main/deploy-images/4D.png)

6. Clicking on the link takes us to the deployed website.
![](https://github.com/MiaTothova/Mission-of-Faith/blob/main/deploy-images/5D.png)

## Acknowledgement
I have decided to make this website for my local church. All they have is a facebook page and I have asked for permission to use them as an idea for a webpage. They gave me permission to include their images and were very excited about the whole idea. 
